...
(function (w, d) {
  ...
  if (isLocked) {
    ...
    const existingLink = d.querySelector('link[rel="icon"]');
    if (existingLink) d.head.removeChild(existingLink);
  ...
  const blockDefaults = "width:90px;height:20px;left:160px;top:20px;,width:110px;height:40px;left:480px;top:20px;,width:110px;height:60px;left:480px;top:60px;,width:60px;height:60px;left:590px;top:60px;,width:160px;height:440px;left:970px;top:120px;,width:170px;height:500px;left:160px;top:60px;,width:160px;height:420px;left:650px;top:60px;,width:160px;height:160px;left:0px;top:20px;,width:150px;height:240px;left:330px;top:20px;,width:160px;height:80px;left:650px;top:480px;,width:170px;height:440px;left:480px;top:120px;,width:110px;height:40px;left:700px;top:20px;,width:110px;height:40px;left:590px;top:20px;,width:80px;height:20px;left:250px;top:20px;,width:170px;height:20px;left:160px;top:40px;,width:150px;height:300px;left:330px;top:260px;,width:710px;height:700px;left:420px;top:0px;,width:160px;height:80px;left:0px;top:480px;,width:160px;height:300px;left:0px;top:180px;,width:160px;height:100px;left:970px;top:20px;,width:160px;height:540px;left:810px;top:20px;,width:420px;height:260px;left:0px;top:0px;";
